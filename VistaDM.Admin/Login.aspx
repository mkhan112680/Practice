<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="VistaDM.Admin.Login" %>
                    ...
                    <tr>
                        <td>
                            <div class="username">
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="Username Required" ControlToValidate="txtUsername"
                    ...
                    <tr>
                        <td width="17%">
                            <div class="squaredThree">
                                <asp:CheckBox runat="server" ID="chkRemember" ClientIDMode="Static" />
        ...
        <div id="main">
            ...
            <div class="grow" style="text-align: center">
                <a href="Register.aspx">
                    <img src="images/button_registernow_large.png" />
                </a>
            </div>
            <br />
            <br />
