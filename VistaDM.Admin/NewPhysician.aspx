<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPhysician.aspx.cs" Inherits="VistaDM.Admin.NewPhysician" %>
        ...
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <table width="70%" border="0" cellspacing="0" cellpadding="0" style="margin-left: auto; margin-right: auto">
                    ...
                    <tr>
                        <td class="italic">CITY <span style="color: #9B2346">*</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="italic">PROVINCE <span style="color: #9B2346">*</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="italic">Physician Type
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:RadioButtonList runat="server" ID="rdoType" RepeatDirection="Horizontal" CssClass="italic">
                                <asp:ListItem Text="PCP" Value="1" />
                                <asp:ListItem Text="CS" Value="2" />
                            </asp:RadioButtonList>
                            <asp:Label Text="Please select a Physician Type" runat="server" ID="lblTypeReq" CssClass="ValText" />
                            <%--<asp:CompareValidator ID="cmprdoType" runat="server" ControlToValidate="rdoType"
                            ValueToCompare="0" ErrorMessage="Please select a Physician Type" Type="String" CssClass="ValText" 
                            ...
                            <fieldset>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtYourFirstName" Width="200px" />
                                            <asp:RequiredFieldValidator ErrorMessage="FirstName required" ControlToValidate="txtYourFirstName"
                                                runat="server" ID="reqtxtYourFirstName" CssClass="ValText" Display="Dynamic" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="italic">Your LastName</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtYourLastName" Width="200px" />
                                            <asp:RequiredFieldValidator ErrorMessage="LastName required" ControlToValidate="txtYourLastName"
                                                runat="server" ID="reqtxtYourLastName" CssClass="ValText" Display="Dynamic" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="italic">Your Email</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtYourEmail" Width="200px" />
                                            <asp:RequiredFieldValidator ErrorMessage="Email required" ControlToValidate="txtYourEmail"
                                                runat="server" ID="reqtxtYourEmail" CssClass="ValText" Display="Dynamic" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
